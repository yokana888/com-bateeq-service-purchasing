...
namespace Com.DanLiris.Service.Purchasing.Test.Controllers.Expedition
{
    public class UnitPaymentOrderPaidStatusReportTest
    {
        ...
        public void Should_Success_Get_Report()
        {
            ...
            mockFacade.Setup(p => p.GetReport(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTimeOffset?>(), It.IsAny<DateTimeOffset?>(), It.IsAny<DateTimeOffset?>(), It.IsAny<DateTimeOffset?>(), It.IsAny<int>()))
            ...
            var response = controller.Get(1, 1, null, null, null, null, null, null, null, null, null);
