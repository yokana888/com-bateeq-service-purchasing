...
namespace Com.DanLiris.Service.Purchasing.Lib.Facades.MonitoringCentralBillReceptionFacades
{
    public class MonitoringCentralBillReceptionFacade : IMonitoringCentralBillReceptionFacade
    {
        ...
        {
            var Query = GetMonitoringTerimaBonPusatByUserReportQuery(dateFrom, dateTo, offset, page, size);

            return Tuple.Create(Query, TotalCountReport);
        }
        public MemoryStream GenerateExcelMonitoringTerimaBonPusat(DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order, int offset)
        {
            var Query = GetMonitoringTerimaBonPusatByUserReportQuery(dateFrom, dateTo, offset, 1, int.MaxValue);
        ...
        private List<MonitoringCentralBillReceptionViewModel> GetMonitoringTerimaBonPusatByUserReportQuery(DateTime? dateFrom, DateTime? dateTo, int offset, int page, int size)
        {
        ...
        public Tuple<List<MonitoringCentralBillReceptionViewModel>, int> GetMonitoringTerimaBonPusatByUserReport(DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order, int offset)
        {
            var Data = GetMonitoringTerimaBonPusatByUserReportQuery(dateFrom, dateTo, offset, page, size);
        ...
        public MemoryStream GenerateExcelMonitoringTerimaBonPusatByUser(DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order, int offset)
        {
            var Query = GetMonitoringTerimaBonPusatByUserReportQuery(dateFrom, dateTo, offset, 1, int.MaxValue);
            DataTable result = new DataTable();
